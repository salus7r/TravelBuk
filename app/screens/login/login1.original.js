...
export class LoginV1 extends React.Component {
  ...
  getThemeImageSource = theme =>
    theme.name === "light" ? require("../../assets/images/backgroundLoginV1.png") : require("../../assets/images/backgroundLoginV1DarkTheme.png");
  ...
  renderImage = () => {
    ...
    return <Image style={[styles.image, imageSize]} source={this.getThemeImageSource(RkTheme.current)} />;
  };
